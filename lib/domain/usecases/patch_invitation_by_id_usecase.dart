...
class PatchInvitationUseCase
    extends UseCase<DataState<InvitationModel>, UpdateInvitationParams> {
  InvitationRepository repository;

  PatchInvitationUseCase(this.repository);

  @override
  Future<DataState<InvitationModel>> call(UpdateInvitationParams params) async {
    return await repository.patchInvitation(params);
  }
}
