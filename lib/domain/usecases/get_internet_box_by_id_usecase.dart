...
class GetInternetBoxByIdUseCase
    extends UseCase<DataState<InternetBoxModel>, int> {
  InternetBoxRepository repository;

  GetInternetBoxByIdUseCase(this.repository);

  @override
  Future<DataState<InternetBoxModel>> call(int params) async {
    return await repository.getInternetBoxById(params);
  }
}
