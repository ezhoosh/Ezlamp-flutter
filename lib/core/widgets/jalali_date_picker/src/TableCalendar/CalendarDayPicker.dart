...
// if mode year on 33 equal one of kabise array year is kabise
  ...
  Widget build(BuildContext context) {
    ...
    itemStyle = DemiBoldStyle.normal;
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        Color tc = MyColors.secondary.shade400;
        if (isSelectedDay) {
          ...
          // The current day gets a different text color.
          itemStyle = itemStyle!.copyWith(color: MyColors.secondary.shade400);
        }
                ...
                child: Semantics(
                  ...
                  child: ExcludeSemantics(
                    child: Text(numberFormatter(day.toString()),
                        style: itemStyle?.copyWith(color: tc)),
                  ),
                ),
              ),
              if (marker != null &&
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: Text(
                    ...
                    style: TitleStyle.t4
                        .copyWith(color: MyColors.white.withOpacity(0.9)),
                  ),
                ),
                Flexible(
